...
const Kryptonite = () => {
    // List of images
    const images = [
        "/assets/img/products/kryptonite.jpg",
        "/assets/img/products/kryptonite.png",
        "/assets/img/products/superman_kryptonite.png",
    ];
                ...
                <div className="container">
                    ...
                    <div className="col-12 col-md-6 ps-lg-10">
                        ...
                        <div className="col">
                            ...
                            {/* <!-- Preheading --> */}
                            <a className="text-muted" href="shop.html">Supplies</a>
                        ...
                        {/* <!-- Heading --> */}
                        <h3 className="mb-2">Kryptonite</h3>

                        {/* <!-- Price --> */}
                        <div className="mb-7">
                        <span className="ms-1 fs-5 fw-bolder text-primary">$899.99</span>
