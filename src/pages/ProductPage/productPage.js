...
import products from '../../data/productsData'; // Import your centralized product data
                            ...
                            <div className="row">
                                <div className="col-12 col-md-6">
                                    ...
                                    <div
                                        className={
                                            product.status === "SALE"
                                                ? "badge bg-dark text-white card-badge text-uppercase"
                                                : product.status === "NEW"
                                                ? "badge bg-dark text-white card-badge text-uppercase"
                                                : product.status === "TRENDING"
                                                ? "badge bg-warning text-body card-badge text-uppercase"
                                                : ""
                                        }
                                    >
                                        {product.status}
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <img
                                            ...
                                            style={{
                                                width: "100%",
                                                height: "auto",
                                                maxHeight: product.maxHeight || "500px",
                                                objectFit: product.objectFit || "contain",
                                                borderRadius: "8px",
                                ...
                                {/* Thumbnails (Only display if more than one image) */}
