                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productTwoColorOne" name="productTwoColor" class="form-check-input" data-toggle="flickity" data-target="#productTwoImg" data-slide="0" style="background-color: red" checked />
                        </div>
                        <div class="form-check form-check-inline form-check-color ms-n2">
                          <input type="radio" id="productTwoColorTwo" name="productTwoColor" class="form-check-input" data-toggle="flickity" data-target="#productTwoImg" data-slide="1" style="background-color: white" />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productTwoSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productTwoSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productTwoSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productTwoSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productTwoSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productTwoSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productTwoSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productTwoSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productTwoSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productThreeColorOne" name="productThreeColor" class="form-check-input" style="background-color: #f9f9f9;" checked />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productThreeSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productThreeSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productThreeSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productThreeSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productThreeSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productThreeSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productThreeSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productThreeSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productThreeSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productFourColorOne" name="productFourColor" class="form-check-input" style="background-color: #f9f9f9;" checked />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFourSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFourSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFourSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFourSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFourSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFourSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFourSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFourSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFourSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productFiveColorOne" name="productFiveColor" class="form-check-input" style="background-color: yellow;" checked />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFiveSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFiveSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFiveSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFiveSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFiveSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFiveSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFiveSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productFiveSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productFiveSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productSixColorOne" name="productSixColor" class="form-check-input" data-toggle="flickity" data-target="#productSixImg" data-slide="0" style="background-color: beige;" checked />
                        </div>
                        <div class="form-check form-check-inline form-check-color ms-n2">
                          <input type="radio" id="productSixColorTwo" name="productSixColor" class="form-check-input" data-toggle="flickity" data-target="#productSixImg" data-slide="1" style="background-color: black;" />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSixSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSixSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSixSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSixSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSixSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSixSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSixSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSixSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSixSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productSevenColorOne" name="productSevenColor" class="form-check-input" style="background-color: black;" checked />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSevenSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSevenSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSevenSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSevenSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSevenSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSevenSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSevenSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productSevenSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productSevenSizeFive" name="sizeRadio" class="form-check-input" />
                ...
                <div class="card-collapse collapse">
                  <div class="card-footer px-0 bg-white">
                    <form>
                      <div class="mb-1">
                        <div class="form-check form-check-inline form-check-color">
                          <input type="radio" id="productEightColorOne" name="productEightColor" class="form-check-input" data-toggle="flickity" data-target="#productEightImg" data-slide="0" style="background-color: black;" checked />
                        </div>
                        <div class="form-check form-check-inline form-check-color ms-n2">
                          <input type="radio" id="productEightColorTwo" name="productEightColor" class="form-check-input" data-toggle="flickity" data-target="#productEightImg" data-slide="1" style="background-color: red;" />
                        </div>
                      </div>
                      <div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productEightSizeOne" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productEightSizeOne">6</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productEightSizeTwo" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productEightSizeTwo">6.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productEightSizeThree" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productEightSizeThree">7</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productEightSizeFour" name="sizeRadio" class="form-check-input" />
                          <label class="form-check-label" for="productEightSizeFour">7.5</label>
                        </div>
                        <div class="form-check form-check-inline form-check-text fs-xs">
                          <input type="radio" id="productEightSizeFive" name="sizeRadio" class="form-check-input" />
