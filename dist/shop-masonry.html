        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-6 d-flex flex-column">
            ...
            <div data-flickity='{"prevNextButtons": true}'>
              ...
              <!-- Card -->
              <a class="w-100 mb-7 bg-cover" href="product.html" style="min-height: 510px; background-image: url(assets/img/products/product-81.jpg);"></a>

              <!-- Card-->
              <a class="w-100 mb-7 bg-cover" href="product.html" style="min-height: 510px; background-image: url(assets/img/products/product-84.jpg);"></a>
